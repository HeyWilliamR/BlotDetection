...
#L2正则默认为0.00004 标准差stddev设定为0.0
    ...
    with tf.variable_scope(scope,"InceptionV3",[inputs]):
        ...
        with slim.arg_scope([slim.conv2d,slim.max_pool2d,slim.avg_pool2d],
            ...
            with tf.variable_scope("Mixed_6a"):
                ...
                with tf.variable_scope("Branch_1"):
                    branch_1 = slim.conv2d(net,64,[1,1],scope ="Conv2s_0a_1x1")
            ...
            with tf.variable_scope("Mixed_6b"):
                ...
                with tf.variable_scope("Branch_2"):
                    branch_2 = slim.conv2d(net,128,[1,1],scope = "Conv2s_0a_1x1")
                    branch_2 = slim.conv2d(branch_2,128,[7,1],scope = "Conv2d_0b_7x1")
                    branch_2 = slim.conv2d(branch_2,128,[1,7],scope = "Conv2d_0c_1x7")
                    branch_2 = slim.conv2d(branch_2,128,[7,1],scope = "Conv2d_0d_1x7")
                    branch_2 = slim.conv2d(branch_2,192,[1,7],scope = "Conv2d_0e_1x7")
                with tf.variable_scope("Branch_3"):
                    branch_3 = slim.avg_pool2d(net,[3,3],scope = "AvgPool_0a_3x3")
                    branch_3 = slim.conv2d(branch_3,192,[3,3],scope="Conv2d_0b_1x1")
                net = tf.concat([branch_0,branch_1,branch_2,branch_3],3)
                with tf.variable_scope("Minxed_6c"):
                    with tf.variable_scope("Branch_0"):
                        branch_0 = slim.conv2d(net,192,[1,1],scope = "Conv2d_0a_1x1")
                    with tf.variable_scope("Branch_1"):
...
def inception_v3(inputs,
    ...
    with tf.variable_scope(scope,"InceptionV3",[inputs,num_classes],reuse=reuse) as scope:
        ...
        with tf.variable_scope("AuxLogits"):
            ...
            end_points["Presictions"] = prediction_fn(logits,scope = "Predictions")
